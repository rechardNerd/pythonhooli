# Script Name       : move_file_vover_x_days.py
# Author(s)         : Craig Richards, Demetrios Bairaktaris
# Created           : 12th Dec 2021
# Version           : 1.0
# Description       : This will move all the files from the src directory that
#                      are over 240 days old to the destiation directory.
...
args_parser.add_argument('-src', '--src', type=str,nargs='?', default='.',
                         help='(OPTION) Directory where files will be moved from. Defaults to current firectory')
...
args_parser.add_argument('-days', '--days', type=int, nargs='?', default=240,
                         help='(OPTION) Days value specifies the mininum age of files to be moved. Default is 240.')
