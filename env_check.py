...
# Author            :   Crag Richards
# Created           :   8th December 2021
# Last Modified     :   8th December 2021
# Mofifications     :   1.0.1 - Tidy up comments and syntax
# Description       :   This scrip will check to see if all of the
#                       evironment variables I require are set

import os

confdir = os.getenv("my_config") # Set the variable confdir from the OS envirment variable
...
for env_check in open(conffilename):    # Open the config file and read all the settings
    ...
    newenv = os.getenv(env_check)   # Set the variable newenv to get setting from the OS what is currently set for the setting out the configfile
